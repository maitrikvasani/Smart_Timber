...
//        wrapper.layoutParams = lp
    ...
    internal fun clickButton(btn: Button, button: Char){
        btn.setOnClickListener {
        controller?.onKeyStroke(button)
        }
    }

    internal fun clickButton(btn: Button,key : KeyboardController.SpecialKey){
            btn.setOnClickListener {
    ...
    internal fun clickButton(text: Button){
        val button = clickButton(text)
        text.setOnClickListener {
            controller?.onKeyStroke('1')
        }
    }
